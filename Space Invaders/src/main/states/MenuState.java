...
public class MenuState extends State implements ActionListener, MouseListener, MouseMotionListener, KeyListener
{
	...
	public void init()
    {
        ...
        //play component
        Component component = new ImageButton(new Point(250,200), "Play", applet, Stage.imgCache.load("data/play.png"), resizeImage(Stage.imgCache.load("data/play.png"),150,45));
        component.addActionListener(this);
        components.add((Component)component);
        //instructions component
        component = new ImageButton(new Point(250,260),"Instructions", applet,Stage.imgCache.load("data/instructions.png"), resizeImage(Stage.imgCache.load("data/instructions.png"),400,45));
        component.addActionListener(this);
        components.add(component);
        //Credits component
        component = new ImageButton(new Point(250,320),"Credits", applet,Stage.imgCache.load("data/credits.png"), resizeImage(Stage.imgCache.load("data/credits.png"),250,45));
        component.addActionListener(this);
        components.add(component);
        /*//HighScore
